	...
	var fabricator = function() {
		...
		function setActiveItem() {
			...
			var setActive = function () {
				...
				for (var i = self.dom.menuItems.length - 1; i >= 0; i--) {

					var item = self.dom.menuItems[i];
		...
		function menuToggle() {
			...
			var toggleClasses = function () {
				...
				var menuClassList = self.dom.root.className.split(' ');
				options.menu = !self.dom.root.classList.contains('f-menu-active');
				self.dom.root.classList.toggle('f-menu-active');
			...
			for (var i = 0; i < self.dom.menuItems.length; i++) {
				self.dom.menuItems[i].addEventListener('click', closeMenu);
			}
		}
